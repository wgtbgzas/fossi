...
BOARD_SUPER_PARTITION_GROUPS := f106pro_dynamic_partitions
BOARD_F106PRO_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext vendor product
BOARD_F106PRO_DYNAMIC_PARTITIONS_SIZE := 8587837440

# Recovery (TWRP)
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/rootdir/etc/recovery.fstab
BOARD_USES_RECOVERY_AS_BOOT := true
BOARD_USES_INIT_BOOT_IMAGE := true
BOARD_USES_DTBOIMAGE := true
